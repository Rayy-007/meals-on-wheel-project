    ...
    <div className="container">
      <section className="flex">
        <div>
          ...
          <br />
          <h3>
            Register For <span className="member-text">Member</span>{" "}
          </h3>
          <h5>
            ....................................to getting supportation of Meal
            daily !
          </h5>{" "}
          <br />
          <br />
          ...
          <div className="background-div">
            ...
            <div className="btn-container">
              <a href="/registerP">
                <button className="btn-regPartner">
                  Join As Partner{" "}
                  <span>
              ...
              <br />
              <a href="/registerC">
                <button className="btn-regCareGiver">
                  Join As Caregiver{" "}
                  <span>
                    <img className="logo-reg-btn" src={getmealicon} />
                  </span>
