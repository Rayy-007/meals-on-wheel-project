    ...
    <div className="home-container container">
      <section className="home flex">
        <div className="left intro">
          <div className="text">
            <h1>
              Delivering <span>Nourishment</span>, Bringing <span>smiles</span>
            </h1>
            <p>
              Welcome to Meals On Wheels, where compassion meets cuisine. We are
              a dedicated team committed to delivering hot, nutritious meals to
              qualified adults in need. Our mission is simple — ensuring that no
              one goes hungry. Whether it's due to age, illness, or disability,
